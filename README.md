...
- That is, the same user enters an initial value and a final value and then the application generates random numbers (random numbers) with those values ​​that will be included between that initial and final value that was added by said user.
